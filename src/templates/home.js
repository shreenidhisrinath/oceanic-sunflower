                  ...
                  <div className="post-feed">
                    ...
                    <article key={post_idx} className="post">
                      ...
                      <p className="read-more">
                        <Link className="read-more-link" to={withPrefix(_.get(post, 'url', null))}>{_.get(this.props, 'pageContext.frontmatter.more_link_text', null) || 'Keep reading'} <span className="icon-arrow-right" aria-hidden="true" /></Link>
                      </p>
                      )}
                    </article>
                    ))}
